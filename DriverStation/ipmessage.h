...
/***Created on:2017-03-09 06:31:14.162472***/
#ifndef IPMESSAGE_H
#define IPMESSAGE_H
#include <QString>
#include <QList>
...
public:
    ...
    int decode_ImageTCP(QByteArray data,std::string* StreamName,quint32* width,quint32* height,quint8* encoding,QByteArray* imagedata);
private:
};
#endif
